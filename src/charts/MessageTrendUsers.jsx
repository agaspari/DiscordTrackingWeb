...
export default class MessageTrendUsers extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    componentDidMount() {
        ...
        fetch (`${window.location.protocol}//${window.location.hostname}:4000/api/messages/trend?guildId=${guildId}&authorizationCode=${authorizationCode}`, {
            method: "GET"
        })
        .then(res => res.json())
        .then(data => {
